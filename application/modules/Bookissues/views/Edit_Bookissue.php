                     	...
                     	<form class="form" method="post" action="<?php echo site_url('bookissues/save-bookissue/'); ?>">
                            ...
                            <fieldset class="col-sm-4">
                                	...
                                	<div class="input-group">
                                      ...
                                      <input type='text' name="issue_date" class="form-control pickadate-selectors square" placeholder="Date" value="<?php echo date('d-F-Y', strtotime($bookissue->issue_date))?>" />
                                    </div>
                                </fieldset>
                            ...
                            <fieldset class="col-sm-4">
                                	...
                                	<div class="input-group">
                                      ...
                                      <input type='text' name="est_return_date" class="form-control pickadate-selectors square" placeholder="Date" value="<?php echo date('d-F-Y', strtotime($bookissue->est_return_date))?>" />
                                    </div>
                                </fieldset>

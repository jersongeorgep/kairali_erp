<div class="card">
                ...
                <div class="card-body">
                    <div class="card-block">
                        <form class="form" method="post" action="<?php echo site_url('office/transactions/save-transaction'); ?>">
                        	<fieldset>
                                	<label>Date</label>
                                	<div class="input-group">
                                      ...
                                      <input type='date' name="tran_date" class="form-control square" min="<?php echo date('Y-m-d', strtotime($accounts->opening_date)); ?>" value="<?php echo date('Y-m-d');?>" placeholder="Date" />
                                    </div>
                                </fieldset>
                             <p></p>
                            <fieldset>
                            ...
                            <fieldset>
                                ...
                                <div class="position-relative has-icon-left">
                                	<input type="text" class="form-control square" name="tran_amount" autocomplete="off" />

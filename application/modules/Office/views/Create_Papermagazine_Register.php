<div class="card">
                ...
                <div class="card-body">
                    <div class="card-block">
                    	...
                    	<form action="<?php echo site_url('office/papermagazineregister/save_register');?>" method="post">
                        <div class="row">
            ...
            <script>
            	function showmonthdays(){
					...
					$.ajax({
							url:"<?php echo site_url('Office/papermagazineregister/getmonlyforms/');?>"+ monthdata +"/"+yeardata,

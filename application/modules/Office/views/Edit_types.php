<div class="card">
                ...
                <div class="card-body">
                    <div class="card-block">
                        <form class="form" method="post" action="<?php echo site_url('office/types/save-types/'.$types->id); ?>">
                        	<fieldset>
                            	<label>Type Name</label>
                                <div class="position-relative has-icon-left">
                                	<input type="text" class="form-control square" name="types_name" autocomplete="off" required value="<?php echo $types->types_name; ?>" />

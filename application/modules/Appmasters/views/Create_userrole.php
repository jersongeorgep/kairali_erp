<div class="card">
                ...
                <div class="card-body">
                    <div class="card-block">
                        <form class="form" method="post" action="<?php echo site_url('appmasters/userrole/save-user-role'); ?>">
                        	<fieldset>
                            	<label>User Role Name</label>
                                <div class="position-relative has-icon-left">
                                	<input type="text" class="form-control square" name="rolename" autocomplete="off" />

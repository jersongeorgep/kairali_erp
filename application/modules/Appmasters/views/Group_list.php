                    ...
                    <div class="card-block">
                        ...
                        <table class="table table-striped table-bordered table-sm">
                            ...
                            <tbody>
                              ...
                              <td><a href="<?php echo site_url('appmasters/groups/edit-groups/'.$gps->id);?>"class="btn btn-primary btn-sm square"><i class="ft-edit-2"></i></a> <a onClick="return confirm('Do you want to delete this record?')" href="<?php echo site_url('appmasters/groups/delete/'.$gps->id); ?>" class="btn btn-danger btn-sm square"><i class="ft-trash-2"></i></a></td></tr>
                              <?php $i++; } ?>
                            </tbody>
                        </table>
                        <?php } 

...
class MY_Model extends CI_Model
{
	...
	public function group_by($criteria) {
		if ( is_array($criteria) )
        {
            foreach ($criteria as $key => $value)
            {
                $this->_database->group_by($key, $value);
            }
        }
        else
        {
    ...
    //	----------------------- ========================
	public function search_by($criteria){
		if ( is_array($criteria) )
        {
            foreach ($criteria as $key => $value)
            {
        ...
        {
            $this->_database->like($criteria, $value);
        }
        return $this;
	}
	...
	public function search_many_by($criteria){
		if ( is_array($criteria) )
        {
            foreach ($criteria as $key => $value)
            {
        ...
        {
            $this->_database->or_like($criteria, $value);
        }
        return $this;
	}
	//=================== Joint Table by Jerson ====================
	public function join_by($feild, $jointable, $joinfeild){
		$this->_database->join($jointable, $this->_table.'.'.$feild.'='.$jointable.'.'.$joinfeild, 'left');
		return $this;
	}
    ...
    public function where_in($column, $where) {
        $this->_database->where_in($column, $where);
        return $this;
    }

    public function or_where_in($column, $where) {
        $this->_database->or_where_in($column, $where);
        return $this;
    }
